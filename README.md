...
on [K8TRE](https://docs.k8tre.org/latest/) and [KARECTL](https://www.karectl.org) . It runs a small but realistic TRE inside a dev
...
![KID architecture](docs/assets/kid-karectl-wide.png)
